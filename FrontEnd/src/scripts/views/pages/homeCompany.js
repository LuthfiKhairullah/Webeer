const HomeCompany = {
  async render() {
    ...
    <div tabindex= "0" id="content-text-dashboard">
     <h1 tabindex= "0" class="fw-bold text-light">Welcome to Webeer</h1>
     <p tabindex= "0" class="text-light fw-semibold fs-5">Hire skilled programmers, the best of them,people will be interested in reading the job posting content page</p>
