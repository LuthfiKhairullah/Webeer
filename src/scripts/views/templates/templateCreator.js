const createSearchTemplate = () => `
  <div class="d-flex gap-2 mx-5 mb-3">
    <input type="text" name="searchElement" id="searchElement" placeholder="Cari Diskusi..." class="form-control">
...
const createDiscussionItemTemplate = (discussion) => `
  <div class="mx-5 mb-3">
    <div class="card w-100">
      <button type="button" class="btn border-0 text-start">
        <div class="card-body">
...
const createAddDiscussionTemplate = () => `
  <a href="/#/adddiscussion" aria-label="Add Discussion" class="add bg-primary text-center text-white border-0 fw-bold text-decoration-none">+</a>
`;
